...
attr_extr=function(core){
    #Read the trip file
    point_file = fread(paste0("points_long_distance",core,".csv"),stringsAsFactors = F)
    ...
    write.csv(trip_file,paste0("trips_long_distance",core,".csv"),row.names = F)
}

#mclapply(0:31, attr_extr)
